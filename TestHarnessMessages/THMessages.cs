...
namespace RemoteBuildServer
{
  ...
  public class TestElement  /* information about a single test */
  {
    ...
    //----< add a test driver to element >---------------------------

    public void addDriver(string name)
    {
      testDriver = name;
    }
    //----< add a tested code to element >---------------------------
  ...
  public class TestRequest  /* a container for one or more TestElements */
  {
    ...
    //----< convert TestRequest to formatted string >-----------------
  ...
  public class TestResult  /* information about processing of a single test */
  {
    ...
    //----< add a log to TestResult >---------------------------------

    public void addLog(string logItem)
    {
      log += logItem;
    }
    //----< convert TestResult to formatted string >------------------
  ...
  public class TestResults  /* a container for one or more TestResult instances */
  {
    ...
    //----< convert TestResults to formatted string >-----------------
...
#if (TEST_THMESSAGES)
  ///////////////////////////////////////////////////////////////////
  // Test stub for TestRequest and TestResult classes
  //
  class TestTHMessages
  {
    ...
    static private void testTestResult()
    {
      ///////////////////////////////////////////////////////////////
      ...
      string typeName = newResults.GetType().Name;
      Console.Write("\n  deserializing xml string results in type: {0}\n", typeName);
